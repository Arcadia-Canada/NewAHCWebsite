...
export const metadata: Metadata = {
  title: "Home Care in North York | Dementia, ABI & Palliative Care | Arcadia",
  description: "Clinically informed home care across North York — dementia care, acquired brain injury, hospital discharge support, palliative care. Serving North York families since 2005.",
  alternates: { canonical: "https://www.arcadiahomecare.ca/locations/toronto/north-york-home-care/" },
};

const faqs = [
  {
    q: "How quickly can Arcadia start providing care in North York?",
    a: "In most cases, we can complete a care assessment within 24–48 hours and have a caregiver in place shortly after. For urgent situations — such as a discharge from North York General or Sunnybrook — we prioritize same-day or next-day starts.",
  },
  {
    q: "Do you work alongside Sunnybrook and North York General discharge teams?",
    a: "Yes. We regularly coordinate with discharge planners and social workers at both Sunnybrook Health Sciences Centre and North York General Hospital. If your loved one is preparing to come home, we can begin the intake process before discharge day.",
  },
  {
    q: "Can I combine Ontario Health atHome funding with Arcadia's private care in North York?",
    a: "Yes — most of our North York clients do exactly this. We help you understand your publicly funded allocation and structure private care around the gaps. Our team handles the coordination so you don't have to navigate two systems alone.",
  },
  {
    q: "Is home care covered by OHIP in North York?",
          ...
          __html: JSON.stringify([
            {
              ...
              description: "Home care in North York — dementia, ABI, palliative care, hospital discharge support.",
              ...
              areaServed: { "@type": "City", name: "North York", containedInPlace: { "@type": "AdministrativeArea", name: "Ontario" } },
              serviceArea: { "@type": "AdministrativeArea", name: "North York" },
            },
            {
              "@context": "https://schema.org",
              "@type": "FAQPage",
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "North York", item: "https://www.arcadiahomecare.ca/locations/toronto/north-york-home-care/" },
              ],
            },
          ]),
        }}
      ...
      <main className="loc-page">
        <section className="loc-hero">
          <div className="loc-hero-inner">
            <p className="loc-eyebrow">Serving North York Families</p>
            <h1>Home Care in North York</h1>
            <p>
              Arcadia provides clinically informed home care across North York — from dementia and
              acquired brain injury support to hospital discharge, palliative care, and daily living
              assistance. We coordinate closely with Sunnybrook Health Sciences Centre and North York
              General Hospital to ensure seamless transitions from hospital to home.
            </p>
            <p>
              Serving North York families since 2005.{" "}
        ...
        <div className="loc-body">
          <article className="loc-article">
            <h2>Hospitals and Health Partners We Work With in North York</h2>
            <p>
              Arcadia coordinates care with discharge planners, social workers, and clinical teams at
              North York&apos;s major hospitals. Families frequently come to us during or after a stay at:
            </p>
            <ul>
              <li><strong>Sunnybrook Health Sciences Centre</strong> — brain injury, geriatric psychiatry, veterans&apos; care, oncology</li>
              <li><strong>North York General Hospital</strong> — seniors&apos; care, post-surgical recovery, complex medicine</li>
              <li><strong>Baycrest Health Sciences</strong> — dementia and cognitive care, geriatric rehabilitation</li>
              <li><strong>Branson Ambulatory Care Centre</strong> — outpatient and day surgery recovery</li>
            </ul>
            <p>
            ...
            <h2>Services Available Across North York</h2>
            <p>Every service Arcadia offers is available to families across North York. The most common needs we see include:</p>
            <ul>
              <li><strong>Dementia and Alzheimer&apos;s home care</strong> — our most requested service in North York, given proximity to Baycrest and Sunnybrook&apos;s memory programs. <Link href="/our-services/dementia-alzheimers-home-care/">Learn more →</Link></li>
              <li><strong>Acquired brain injury care</strong> — coordinated with Sunnybrook&apos;s rehabilitation teams and your OT, PT, and specialist. <Link href="/our-services/acquired-brain-injury-home-care/">Learn more →</Link></li>
              <li><strong>Hospital discharge support</strong> — safe transitions from North York General and Sunnybrook to home, starting from day one. <Link href="/our-services/hospital-discharge-support/">Learn more →</Link></li>
              ...
              <li><strong>Respite care</strong> — relief for family caregivers across North York. <Link href="/our-services/respite-care/">Learn more →</Link></li>
            ...
            <h2>Neighbourhoods We Serve in North York</h2>
            <p>Arcadia caregivers serve families across North York, including:</p>
            <p><strong>Central North York:</strong> Willowdale, Newtonbrook, Lansing, Bathurst Manor, Clanton Park, Northtown</p>
            <p><strong>East North York:</strong> Don Mills, Flemingdon Park, Parkwoods, Victoria Village, Bermondsey</p>
            <p><strong>West North York:</strong> York Mills, Lawrence Park North, Bedford Park, Armour Heights, Hoggs Hollow, Elia</p>
            <p>
              North York is home to some of Canada&apos;s leading memory and rehabilitation programs —
              Baycrest Health Sciences and Sunnybrook&apos;s brain sciences centre are both here. Many
              families we support are adult children coordinating care while working downtown, managing
              a parent who lives independently in a condo or apartment along Yonge, Sheppard, or
              Bayview. Arcadia&apos;s caregivers are experienced in building trusted routines within
              apartment buildings and high-rise communities where aging in place looks different than
              in a house — and where a consistent, familiar face matters most.
            </p>

            <p>
              For care in central Toronto, Scarborough, or Etobicoke, see our dedicated pages:{" "}
              ...
              <Link href="/locations/toronto/etobicoke-home-care/">Etobicoke home care →</Link>.
            </p>

            <h2>Navigating the Ontario Home Care System in North York</h2>
            <p>
              Many North York families accessing home care for the first time are unsure how to combine
              publicly funded support through Ontario Health atHome with private care. Wait times for
              public care can be long and hours limited — most families we work with use a combination
              of both.
            </p>
            <p>
              Arcadia&apos;s team can help you understand what you&apos;re entitled to through Ontario Health
              atHome, coordinate with Sunnybrook or North York General&apos;s discharge teams, and structure
            ...
            <div className="faq-section">
              ...
              <h2>Questions families ask about home care in North York</h2>
              {faqs.map((faq, i) => (
        ...
        <section className="loc-bottom-cta">
          <h2>Start a Conversation About Care in North York</h2>
