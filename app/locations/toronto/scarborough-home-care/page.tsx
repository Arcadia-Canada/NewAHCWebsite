...
const faqs = [
  {
    q: "How quickly can Arcadia start providing care in Scarborough?",
    a: "In most cases, we can complete a care assessment within 24–48 hours and have a caregiver in place shortly after. For urgent situations — such as a discharge from Scarborough Health Network — we prioritize same-day or next-day starts.",
  },
  {
    q: "Do you work with Scarborough Health Network discharge teams?",
    a: "Yes. We regularly coordinate with discharge planners and social workers at Scarborough Health Network's Birchmount, General, and Centenary sites. If your loved one is preparing to come home, we can begin the intake process before discharge day.",
  },
  {
    q: "Can I combine Ontario Health atHome funding with Arcadia's private care in Scarborough?",
    a: "Yes — most of our Scarborough clients do exactly this. We help you understand your publicly funded allocation and structure private care around the gaps. Our team handles the coordination so you don't have to navigate two systems alone.",
  },
  {
    q: "Is home care covered by OHIP in Scarborough?",
          ...
          __html: JSON.stringify([
            {
              ...
              areaServed: { "@type": "City", name: "Scarborough", containedInPlace: { "@type": "AdministrativeArea", name: "Ontario" } },
              serviceArea: { "@type": "AdministrativeArea", name: "Scarborough" },
            },
            {
              "@context": "https://schema.org",
              "@type": "FAQPage",
      ...
      <main className="loc-page">
        <section className="loc-hero">
          <div className="loc-hero-inner">
            <p className="loc-eyebrow">Serving Scarborough Families</p>
            <h1>Home Care in Scarborough</h1>
            <p>
              Arcadia provides clinically informed home care across Scarborough — from dementia and
              acquired brain injury support to hospital discharge, palliative care, and daily living
              assistance. We work closely with Scarborough Health Network&apos;s three sites to ensure
              seamless transitions from hospital to home.
            </p>
            <p>
              Serving Scarborough families since 2005.{" "}
        ...
        <div className="loc-body">
          <article className="loc-article">
            <h2>Hospitals and Health Partners We Work With in Scarborough</h2>
            <p>
              Arcadia coordinates care with discharge planners, social workers, and clinical teams
              across Scarborough&apos;s health network. Families frequently come to us during or after
              a stay at:
            </p>
            <ul>
              <li><strong>Scarborough Health Network — Birchmount Site</strong> — cardiac care, complex chronic disease, stroke</li>
              <li><strong>Scarborough Health Network — General Site</strong> — emergency, surgery, and post-acute care</li>
              <li><strong>Scarborough Health Network — Centenary Site</strong> — orthopaedics, oncology, complex medicine</li>
              <li><strong>Providence Healthcare</strong> — rehabilitation, complex continuing care, long-term care transitions</li>
            </ul>
            <p>
            ...
            <h2>Services Available Across Scarborough</h2>
            <p>Every service Arcadia offers is available to families across Scarborough. The most common needs we see include:</p>
            <ul>
              ...
              <li><strong>Acquired brain injury care</strong> — coordinated with your rehabilitation and specialist team following stroke or ABI. <Link href="/our-services/acquired-brain-injury-home-care/">Learn more →</Link></li>
              <li><strong>Hospital discharge support</strong> — safe transitions from Scarborough Health Network sites to home. <Link href="/our-services/hospital-discharge-support/">Learn more →</Link></li>
              ...
              <li><strong>Respite care</strong> — relief for family caregivers across Scarborough. <Link href="/our-services/respite-care/">Learn more →</Link></li>
            ...
            <h2>Neighbourhoods We Serve in Scarborough</h2>
            <p>Arcadia caregivers serve families across Scarborough, including:</p>
            <p><strong>West Scarborough:</strong> Birchcliffe, Cliffside, Clairlea, Oakridge, Wexford, Dorset Park</p>
            <p><strong>Central Scarborough:</strong> Agincourt, L&apos;Amoreaux, Tam O&apos;Shanter, Sullivan, Bendale, Ionview</p>
            <p><strong>East Scarborough:</strong> Malvern, Rouge, West Hill, Morningside, Guildwood, Scarborough Village, Woburn</p>
            <p>
              Many Scarborough families we work with live in multi-generational homes or are supporting
              parents who immigrated to Canada later in life. Our caregivers are experienced in working
              with culturally diverse families across Agincourt, Malvern, and Guildwood — including
              families where English is a second language and cultural familiarity matters in a caregiver match.
            </p>

            <p>
              For care in central Toronto, North York, or Etobicoke, see our dedicated pages:{" "}
            ...
            <h2>Navigating the Ontario Home Care System in Scarborough</h2>
            <p>
              Many Scarborough families accessing home care for the first time are unsure how to
            ...
            <p>
              ...
              atHome, coordinate with Scarborough Health Network&apos;s discharge teams, and structure
            ...
            <div className="faq-section">
              ...
              <h2>Questions families ask about home care in Scarborough</h2>
              {faqs.map((faq, i) => (
        ...
        <section className="loc-bottom-cta">
          <h2>Start a Conversation About Care in Scarborough</h2>
