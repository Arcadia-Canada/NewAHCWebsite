...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://arcadiahomecare.ca/our-services/rehabilitation-support/' },
}
          ...
          __html: JSON.stringify([
            ...
            },
            {
              ...
              'itemListElement': [
                ...
                { '@type': 'ListItem', 'position': 3, 'name': 'Rehabilitation Support', 'item': 'https://arcadiahomecare.ca/our-services/rehabilitation-support/' },
              ],
            },
          ]),
        }}
        ...
        <section className="service-hero">
          <div className="service-hero-inner">
            <div>
              ...
              <h1>Rehabilitation Support at Home</h1>
              <p>
                Recovery from injury or serious illness does not end when inpatient
                rehabilitation ends. The work of rebuilding independence happens at home,
                in real environments, with real demands. Arcadia's trained Rehabilitation
                Support Workers help clients apply and generalize their rehabilitation
                gains in the community — under clinical supervision and in coordination
            ...
            <div className="hero-trust">
              {[
                { icon: '🧠', title: 'RSW supervision by a qualified clinician', body: 'All rehabilitation support cases supervised by an experienced rehabilitation clinician — not just coordinated by a scheduler.' },
                { icon: '🤝', title: 'Active coordination with treating teams', body: 'We implement programs developed by OTs, physiotherapists, and SLPs — not independently of them.' },
                { icon: '📋', title: 'Experienced with WSIB and auto insurance', body: 'Familiar with funded care documentation requirements and processes.' },
                { icon: '📍', title: 'Toronto and GTA coverage', body: 'Serving families across Toronto, York Region, Peel Region, and beyond.' },
              ].map((item, i) => (
