...
const steps = [
  ...
  { num: 4, title: "First Week of Care", description: "Care begins with close monitoring and daily check-ins to ensure everything is working well for your family.", href: "/how-care-starts/care-begins/", icon: "📅" },
